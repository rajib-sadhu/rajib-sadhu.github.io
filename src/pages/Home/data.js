const data = [
    {
        ...
        subTitle: 'full stack',
        images: [
            'https://i.ibb.co/3vV3F1x/Screenshot-2023-08-19-173342.png',
            'https://i.ibb.co/1QB8swz/Screenshot-2023-08-19-172006.png',
            'https://i.ibb.co/QrmntTf/Screenshot-2023-08-19-172032.png',
            'https://i.ibb.co/wdJfw0L/Screenshot-2023-08-19-171903.png',
            'https://i.ibb.co/mTG0wzY/Screenshot-2023-08-19-173756.png',
            'https://i.ibb.co/qrMBGdr/Screenshot-2023-08-19-173850.png',
            'https://i.ibb.co/MhNSZSk/Screenshot-2023-08-19-174542.png'
        ],
        disc: "Unleash creativity in summer. Enroll seamlessly, instructors manage classes, admin ensures quality. Explore filmmaking, master storytelling.",
        features: [
            'Dive into filmmaking during vacations, discovering the magic of storytelling through courses.',
            'Easily choose classes, add to cart, and enroll securely via integrated payment gateway.',
            'Instructors manage classes, set seats, and gain exposure to a keen audience.',
            'Quality ensured with admin approval of courses, ensuring a valuable learning journey.',
            'Laptop, Tablet, Mobile Device responsive.',
            'Admin can provide feedback and approval for instructor-submitted classes.',
            'Secure authentication process using Firebase, supporting social media and Google logins with jwt.'
        ],
